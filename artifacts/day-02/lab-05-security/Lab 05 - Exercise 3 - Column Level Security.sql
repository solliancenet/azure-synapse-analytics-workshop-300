    ...
    */
    ...
    REVOKE SELECT ON wwi_security.Sale_#USER_CONTEXT# FROM DataAnalystMiami;
    GRANT SELECT ON wwi_security.Sale_#USER_CONTEXT#([ProductID], [Analyst], [Product], [CampaignName],[Quantity], [Region], [State], [City], [RevenueTarget]) TO DataAnalystMiami;
    ...
    Revert;
    GRANT SELECT ON wwi_security.Sale_#USER_CONTEXT# TO CEO;  --Full access to all columns.
