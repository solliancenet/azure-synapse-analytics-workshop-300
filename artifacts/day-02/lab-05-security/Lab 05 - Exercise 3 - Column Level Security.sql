    ...
    select  Top 100 * from wwi_Security.Sale_#USER_CONTEXT#
    ...
    SELECT Name as [User1] FROM sys.sysusers WHERE name = N'CEO_#USER_CONTEXT#';
    SELECT Name as [User2] FROM sys.sysusers WHERE name = N'DataAnalystMiami_#USER_CONTEXT#';
    ...
    */
    ...
    REVOKE SELECT ON wwi_security.Sale_#USER_CONTEXT# FROM DataAnalystMiami_#USER_CONTEXT#;
    GRANT SELECT ON wwi_security.Sale_#USER_CONTEXT#([ProductID], [Analyst], [Product], [CampaignName],[Quantity], [Region], [State], [City], [RevenueTarget]) TO DataAnalystMiami_#USER_CONTEXT#;
    ...
    EXECUTE AS USER ='DataAnalystMiami_#USER_CONTEXT#';
    select [ProductID], [Analyst], [Product], [CampaignName],[Quantity], [Region], [State], [City], [RevenueTarget] from wwi_security.Sale_#USER_CONTEXT#;
    ...
    Revert;
    GRANT SELECT ON wwi_security.Sale_#USER_CONTEXT# TO CEO_#USER_CONTEXT#;  --Full access to all columns.
