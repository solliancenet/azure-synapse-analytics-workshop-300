...
IF OBJECT_ID(N'[wwi_perf].[Sale_Partition02_#USER_CONTEXT#]', N'U') IS NOT NULL   
DROP TABLE [wwi_perf].[Sale_Partition02_#USER_CONTEXT#] 

CREATE TABLE [wwi_perf].[Sale_Partition02_#USER_CONTEXT#]
WITH
(
...
OPTION  (LABEL  = 'CTAS : Sale_Partition02_#USER_CONTEXT#')